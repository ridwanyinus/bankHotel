...
const About = () => {
  return (
    <main className="bg-primary mt-0 sm:py-14 lg:pt-10  px-5 md:px-[1.9rem] largesceen:px-14 fourk:px-44 ">
      ...
      <section className="desktop:pt-28  flex flex-col lg:flex-row justify-between">
        <div>
        ...
        <div className="flex flex-col justify-end gap-48 relative max-lg:mt-8">
          ...
          <div className="lg:ml-24 desktop:ml-0 relative  largesceen:mt-20">
            <h3 className="text-3xl sm:text-[1.75rem] desktop:text-4xl largesceen:text-[3.125rem] text-white-100 tracking-[0.094rem] mb-8 w-fit">High quality</h3>
