  ...
  return (
    <footer
      ...
      <section className="py-8 sm:py-12 lg:py-20 desktop:py-32 largesceen:py-44 flex  justify-between relative w-full">
        <div className="">
          <h2 className=" text-white-100 uppercase xs:text-[5.25rem] sm:text-[7rem] leading-none lg:text-[8rem] desktop:text-[12.625rem] largesceen:text-[18.75rem] max-sm:absolute" data-aos="fade-up">
