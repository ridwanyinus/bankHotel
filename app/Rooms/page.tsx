        ...
        <section className="bg-primary py-12 sm:py-28 px-5 md:px-[1.9rem] desktop:px-28 largesceen:px-44 ">
          ...
          <div className="lg:flex justify-between pt-12 xl:pt-28">
            ...
            <p className="w-[90%] sm:w-[80%] lg:w-[22.4rem] desktop:w-[20.938rem] largesceen:w-[21.875rem] text-white-100 text-lg leading-[155.556%] text-opacity-[0.8] pt-12 lg:pt-0 ">
              The Superior twin would perfectly match the needs of those who plan to stay long. The bright and airy room is equipped with superior soft Italian furniture. Large windows open a
              beautiful view to the historical part of the city. Contemporary interior design and comfortable beds will make your stay cozy and delightful.
            </p>
          </div>
        </section>
