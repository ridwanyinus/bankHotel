    ...
    <main className="pb-20 lg:pb-28 largesceen:pb-44 overflow-hidden">
      <section className="relative w-full  h-full">
        <Image
          src={best}
          alt="diver"
          className="absolute  top-0 right-0  largesceen:w-full desktop:pb-44 h-96 md:h-[25.438rem] lg:h-[30.438rem] xl:h-[45.75rem] desktop:h-auto largesceen:h-[80.188rem] max-sm:object-cover"
          priority
          placeholder="blur"
        />

        <div className="relative px-5 md:px-[1.9rem] largesceen:px-14 fourk:px-44 pt-12 desktop:pt-28 largesceen:pt-44">
          <h2 className="text-secondary  text-[3.2rem] leading-none lg:text-[6.25rem] desktop:text-[7.813rem] largesceen:text-[9.375rem] mb-32 sm:mb-28 lg:mb-36">
